...
"""
Long mean reverting rsi system on VOO daily
2007 TO 2024 OPTIMIZED RSI 4 LONG 30 FLAT 55
EMA20 > EMA50 FILTER
...
def daily_1500_check_and_execute():
    ...
    # sell condition check
        ...
        print(f"rsi={rsi}, ema20={ema20}, ema50={ema50}, sell condition met")
        # sell loop
        for account in active_accounts:
            current_position = api.has_open_position(account, TICKER)
            if current_position:
        ...
        print(f"rsi={rsi}, ema20={ema20}, ema50={ema50}, buy/sell condition not met, no action needed")
